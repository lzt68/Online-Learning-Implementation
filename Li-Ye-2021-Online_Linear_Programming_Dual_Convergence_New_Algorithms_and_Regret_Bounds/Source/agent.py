...
class NoNeedtoLearn(object):
    def __init__(self, m: int, n: int, b: np.array, sample_num: int = 100000, input_name: str = "RandomInputI") -> None:
        ...
        $$
        We solve this stochastic programming problem via SAA scheme with 10^6 samples.
        ...
        Args:
            ...
            sample_num (int, optional): Sample number when we adopt SAA method to solve the stochastic problem. Defaults to 100000.
